...
PLATFORM_TERMS_VERSION = env("PLATFORM_TERMS_VERSION", default="2026-08")
PRIVACY_NOTICE_VERSION = env("PRIVACY_NOTICE_VERSION", default="2026-08")
ESCROW_LIVE_ACTIVATION_ENABLED = env.bool("ESCROW_LIVE_ACTIVATION_ENABLED", default=False)
FINANCING_LIVE_ACTIVATION_ENABLED = env.bool(
    "FINANCING_LIVE_ACTIVATION_ENABLED", default=False
)
